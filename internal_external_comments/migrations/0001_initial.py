# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-02 19:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_external', models.CharField(choices=[('internal', 'Internal'), ('external', 'External')], default='internal', max_length=8)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_type_set_for_commentinternalexternal', to='contenttypes.ContentType', verbose_name='content type')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sites.Site')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='commentinternalexternal_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
